...
TableView::TableView(QWidget *parent) : QWidget(parent)
{
    ...
    setWindowTitle(codec->toUnicode("Все элементы таблицы"));
    ...
    discLabel -> setText(codec->toUnicode("Все элементы: "));
...
void TableView::AddTable(std::vector<Element> origin,int size)
{
    table->setHorizontalHeaderLabels(list);
    int i =0;
    size = 120;
